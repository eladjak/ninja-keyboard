...
export const CHAPTER_6_5_MASTER_BEAT: DialogStoryBeat = {
  ...
  lines: [
    ...
    {
      id: 'ch6-5-06',
      character: 'masterBeat',
      text: 'בהתחלה... היה... המקש.',
      type: 'dialog',
      mood: 'epic',
      expression: 'idle',
      duration: 2000,
    },
    {
      id: 'ch6-5-06b',
      character: 'masterBeat',
      text: 'ובסוף... יהיה... המקש. בין... לבין — הכל.',
      type: 'dialog',
      mood: 'epic',
      expression: 'idle',
      duration: 3000,
    ...
    },
    {
      id: 'ch6-5-08',
      character: 'masterBeat',
      text: 'אומנות... ההקלדה. לא... אצבעות... על... מקשים. החיבור. גשר. בין... שני... עולמות.',
      type: 'dialog',
      mood: 'epic',
      expression: 'idle',
      duration: 4000,
    },
    {
      id: 'ch6-5-08b',
      character: 'senseiZen',
      text: 'הוא מלמד: כשהגשר הזה שלם — אף שחיתות לא יכולה לעבור.',
      type: 'dialog',
      mood: 'epic',
      expression: 'idle',
      duration: 4000,
    ...
    },
    {
      id: 'ch6-5-10',
      character: 'masterBeat',
      text: 'הגשר... בנוי... מאבנים... שונות. רק... כשכולן... במקום — הוא... עומד.',
      type: 'dialog',
      mood: 'heartwarming',
      expression: 'happy',
      duration: 3000,
